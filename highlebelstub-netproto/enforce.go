...
func ensure_system_state() {
	fmt.Println("[*] Taking exclusive control of network stack...")
	run("systemctl enable systemd-networkd systemd-resolved 2>/dev/null")
	run("systemctl start systemd-networkd systemd-resolved 2>/dev/null")
